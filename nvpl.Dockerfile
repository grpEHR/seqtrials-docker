...
RUN <<EOF
    ...
    update-alternatives --install \
      ...
      /usr/lib/aarch64-linux-gnu/libnvpl_blas_lp64_seq.so 150
    
    update-alternatives --install \
      /usr/lib/aarch64-linux-gnu/liblapack.so.3 \
      liblapack.so.3-aarch64-linux-gnu \
      /usr/lib/aarch64-linux-gnu/libnvpl_lapack_lp64_seq.so 150
    
    # Then set
    update-alternatives --config libblas.so.3-aarch64-linux-gnu
    update-alternatives --config liblapack.so.3-aarch64-linux-gnu
