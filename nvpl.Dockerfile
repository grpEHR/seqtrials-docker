...
RUN <<EOF
    ...
    update-alternatives --install \
      ...
      /usr/lib/aarch64-linux-gnu/libnvpl_blas_lp64_seq.so.0 150
    
    update-alternatives --install \
      /usr/lib/aarch64-linux-gnu/liblapack.so.3 \
      liblapack.so.3-aarch64-linux-gnu \
      /usr/lib/aarch64-linux-gnu/libnvpl_lapack_lp64_seq.so.0 150
    
    # Then set
    update-alternatives --set libblas.so.3-aarch64-linux-gnu /usr/lib/aarch64-linux-gnu/libnvpl_blas_lp64_seq.so.0
    update-alternatives --set liblapack.so.3-aarch64-linux-gnu /usr/lib/aarch64-linux-gnu/libnvpl_lapack_lp64_seq.so.0
